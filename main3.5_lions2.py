...
# py .\main3.5_lions2.py

# ==================== KONFIGURACJA ====================

flags = [
    {"path": "./images/flags/flag_6.png", "wait": 3, "stops": 0},
    {"path": "./images/flags/flag_1.png", "wait": 5, "stops": 0},
    {"path": "./images/flags/flag_2.png", "wait": 6, "stops": 2},
    {"path": "./images/flags/flag_3.png", "wait": 6, "stops": 1},
    {"path": "./images/flags/flag_5.png", "wait": 4, "stops": 0},
]
...
def check_flag(flag_path, max_walk_time=15, stops=0):
    ...
    if stops == 0:
        ...
        time_left = max_walk_time - elapsed

        if time_left >= 2:
            change_one_gold_stack()
            elapsed = time.time() - start  # przelicz po wykonaniu

        # ile jeszcze zostało do "chodzenia"
        remaining = max_walk_time - elapsed
        if remaining > 0:
